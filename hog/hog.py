...
def is_prime(n):
    return len([x for x in range(1, n) if n % x == 0]) == 1
...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    n1 = opponent_score % 10
    n2 = opponent_score // 10
...
def select_dice(score, opponent_score):
    ...
    if sum([score, opponent_score]) % 7 == 0:
        return four_sided
    else:
        return six_sided
...
def play(strategy0, strategy1, score0=0, score1=0, goal=GOAL_SCORE):
    ...
    while score0 < goal and score1 < goal:
        ...
        rolls = my_strategy(my_score, other_score)

        #print('***before***')
        #print('my_score:', my_score, 'other_score:', other_score, 'rolls:', rolls)

        score = take_turn(rolls, other_score, select_dice(my_score, other_score))
        ...
        if is_swap(my_score, other_score):
            temp = my_score
            my_score = other_score
            other_score = temp

        #print('---after---')
        #print('my_score:', my_score, 'other_score:', other_score)
